    ...
    <div className={cn('w-full', className)} style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
        ...
        <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
          Banks use leverage to amplify returns on assets into higher returns on equity. Adjust the
          sliders or select a real bank to see how leverage works.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            >
              <div>
                <span style={{ fontSize: '14px', color: 'rgb(99, 102, 241)', fontWeight: 600 }}>
                  ROA
                </span>
                <div
            ...
            <div
              style={{
                ...
                alignItems: 'center',
                padding: '16px',
                backgroundColor: isHighLeverage
                  ? 'rgba(245, 158, 11, 0.15)'
                  : 'rgba(245, 158, 11, 0.1)',
                borderRadius: '10px',
                border: isHighLeverage
                  ? '2px solid rgba(245, 158, 11, 0.4)'
                  : '1px solid rgba(245, 158, 11, 0.2)',
              }}
            >
              <div>
                <span style={{ fontSize: '14px', color: 'rgb(245, 158, 11)', fontWeight: 600 }}>
                  Leverage
                </span>
                <div
                  style={{ fontSize: '11px', color: 'var(--color-text-muted)', marginTop: '2px' }}
            ...
            >
              <div>
                <span
                  style={{
                    fontSize: '14px',
                    color: roe > 0 ? 'rgb(16, 185, 129)' : 'rgb(239, 68, 68)',
                    fontWeight: 600,
                  }}
                >
                  ROE
      ...
      >
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
          ...
          <div>
            ...
            >
              Banks typically earn 1-1.5% ROA, but leverage of 10-12x transforms this into 10-15%
              ROE. This is why banking is attractive despite thin profit margins on assets.
            </div>
          </div>
        </div>
      </motion.div>
      ...
      {isHighLeverage && (
        <motion.div
          ...
          style={{
            padding: '16px',
            backgroundColor: isVeryHighLeverage
              ? 'rgba(239, 68, 68, 0.15)'
              : 'rgba(245, 158, 11, 0.15)',
            border: isVeryHighLeverage
        ...
        >
          ...
          <div>
            ...
            <div
              style={{ fontSize: '13px', color: 'var(--color-text-secondary)', lineHeight: '1.6' }}
            >
              High leverage amplifies both gains AND losses. A {leverage.toFixed(0)}x leverage ratio
              means a {((1 / leverage) * 100).toFixed(1)}% loss on assets would wipe out all equity.
              {isVeryHighLeverage &&
                ' This level of leverage contributed to bank failures in 2008.'}
            </div>
          </div>
        </motion.div>
      )}
