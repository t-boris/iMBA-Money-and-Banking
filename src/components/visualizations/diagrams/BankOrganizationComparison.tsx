                ...
                >
                  <div
                    style={{
                      width: '2px',
                      height: '16px',
                      backgroundColor: `rgb(${form.colorRgb})`,
                    }}
                  />
                  <div
                    style={{
        ...
        {isSelected && (
          ...
          >
            ...
            >
              <div>
                <div
                  style={{ fontWeight: 600, color: `rgb(${form.colorRgb})`, marginBottom: '6px' }}
                >
                  Advantages
                </div>
                <ul
              ...
              <div>
                <div
                  style={{ fontWeight: 600, color: 'var(--color-text-muted)', marginBottom: '6px' }}
                >
                  Disadvantages
                </div>
                <ul
    ...
    <div className={cn('w-full', className)} style={{ maxWidth: '1000px', margin: '0 auto' }}>
      ...
      >
        <div style={{ fontSize: '13px', color: 'var(--color-text-secondary)', lineHeight: '1.7' }}>
          <strong style={{ color: 'var(--color-text-primary)' }}>Key Insight:</strong> Banking
          organization evolved in response to regulatory constraints. Unit banking laws led to
          holding company structures, and Glass-Steagall&apos;s repeal enabled financial holding
          companies that combine banking, securities, and insurance.
        </div>
      </motion.div>
