...
const incomeData: IncomeItem[] = [
  { id: 'interest-income', label: 'Interest Income', jpmorgan: 89, community: 42, type: 'add', description: 'Income from loans and securities' },
  { id: 'interest-expense', label: 'Interest Expense', jpmorgan: 29, community: 12, type: 'subtract', description: 'Cost of deposits and borrowings' },
  { id: 'nii', label: 'Net Interest Income', jpmorgan: 60, community: 30, type: 'result', description: 'Core banking profit' },
  { id: 'fee-income', label: 'Non-Interest Income', jpmorgan: 58, community: 8, type: 'add', description: 'Fees, trading, asset management' },
  { id: 'total-revenue', label: 'Total Revenue', jpmorgan: 118, community: 38, type: 'result', description: 'All revenue sources combined' },
  { id: 'operating-expense', label: 'Operating Expense', jpmorgan: 69, community: 24, type: 'subtract', description: 'Salaries, technology, facilities' },
  { id: 'provisions', label: 'Loan Loss Provisions', jpmorgan: 8, community: 2, type: 'subtract', description: 'Reserve for expected defaults' },
  { id: 'net-income', label: 'Net Income', jpmorgan: 41, community: 12, type: 'result', description: 'Bottom line profit' },
];
