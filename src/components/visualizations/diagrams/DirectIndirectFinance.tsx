...
export function DirectIndirectFinance({ className }: DirectIndirectFinanceProps) {
    ...
    <div className={cn('w-full', className)} style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
        ...
        <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
          Savers can provide funds to borrowers through markets (direct) or through financial
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '11px', color: 'rgb(16, 185, 129)', fontWeight: 500 }}>
                Buys securities
              </span>
              <div style={{ width: '2px', height: '20px', backgroundColor: 'rgb(16, 185, 129)' }} />
            </div>
            ...
            >
              ...
              <div style={{ fontSize: '14px', fontWeight: 600, color: 'rgb(16, 185, 129)' }}>
                Financial Markets
              </div>
              <div style={{ fontSize: '11px', color: 'var(--color-text-muted)' }}>
                Stocks, Bonds, etc.
          ...
          {selectedPath === 'direct' && (
            ...
            >
              ...
              >
                <strong style={{ color: 'rgb(16, 185, 129)' }}>Key:</strong> Lender bears the risk
                directly. If borrower defaults, lender loses money. No intermediary absorbs losses.
              </p>
            </motion.div>
          )}
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '11px', color: 'rgb(99, 102, 241)', fontWeight: 500 }}>
                Deposits
              </span>
              <div style={{ width: '2px', height: '20px', backgroundColor: 'rgb(99, 102, 241)' }} />
            </div>
            ...
            >
              <span style={{ fontSize: '28px' }}>🏦</span>
              <div style={{ fontSize: '14px', fontWeight: 600, color: 'rgb(99, 102, 241)' }}>
                Bank / Institution
              </div>
              <div style={{ fontSize: '11px', color: 'var(--color-text-muted)' }}>
          ...
          {selectedPath === 'indirect' && (
            ...
            >
              ...
              >
                <strong style={{ color: 'rgb(99, 102, 241)' }}>Key:</strong> Bank bears the risk. If
                borrower defaults, bank absorbs the loss. Depositor&apos;s money is safe (up to
                insurance limits).
              </p>
            </motion.div>
          )}
      ...
      >
        ...
        >
          <div>
            <div style={{ fontWeight: 600, color: 'rgb(16, 185, 129)', marginBottom: '8px' }}>
              Direct Finance
            </div>
            <ul
              style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: 'rgb(99, 102, 241)', marginBottom: '8px' }}>
              Indirect Finance
            </div>
            <ul
              style={{
